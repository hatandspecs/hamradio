...
<img src="{{ '/assets/images/using_wspr_wsjtx/wspr-wsjtx-2026-04-26 16-51.png' | relative_url }}" alt="WSJT-X Running WSPR">
...
<img src="{{ '/assets/images/using_wspr_wsjtx/wsprrocks_20260426-172319.png' | relative_url }}" alt="WSPR Rocks TX Map">
...
[WSPR Results Analysis on DIY 75-10m EFHW](../7510-wspr-results-analysis/)